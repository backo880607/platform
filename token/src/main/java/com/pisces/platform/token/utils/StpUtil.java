package com.pisces.platform.token.utils;

import com.pisces.platform.token.login.SaLoginModel;
import com.pisces.platform.token.login.SaTokenInfo;
import com.pisces.platform.token.login.StpLogic;
...
//		SaTokenEventCenter.doSetStpLogic(stpLogic);
	 ...
	 */
	public static void login(Object id, int timeout) {
